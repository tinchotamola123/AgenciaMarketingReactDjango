    ...
    return (
        <main>
            <div className="relative px-6 lg:px-8">
                <div className="mx-auto lg:mx-12 max-w-full xl:mx-12 xl:pt-32 xl:pb-38 lg:pt-40 lg:pb-48 pt-24 pb-12  ">
                    <div>
                        <div>
                            <h1 className="text-4xl font-semibold tracking-tight pb-2  sm:text-7xl">
                                Nosotros
                            </h1>
                            <p className="mt-6 text-2xl max-w-2xl leading-10 text-black max-w-5xl">
