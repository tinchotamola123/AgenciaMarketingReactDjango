...
function PositionList() {
    return (
        <>
            ...
            <div className="max-w-full mx-12 ng-white">
                <h2 className="text-3xl font-semibold text-gray-900 pb-8">Open Positions</h2>
                <p className="text-1xl font-regular text-gray-900 max-w-5xl leading-10">Let's write some beautiful code and make smart designs. This is what we're crazy about, and we're looking for the ones who feel the same.</p>
